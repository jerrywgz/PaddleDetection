    ...
    def __init__(self,
                 ...
                 sample_transforms=[
                     ...
                     ColorDistort(saturation=0.4,
                                  ...
                                  brightness=0.4,
                                  corner_jitter=True),
                     Lighting(eigval=[0.2142, 0.01818, 0.003416],
                              eigvec=[[-0.5875, -0.6956, 0.4134],
                                      [-0.5833, 0.009945, -0.8122],
                                      [-0.5609, 0.7183, 0.4116]]),
                     NormalizeImage(mean=[0.4079, 0.4472, 0.4703],
                                    std=[0.2886, 0.2741, 0.2781],
                                    is_scale=False,
                                    is_channel_first=False),
                     Permute(to_bgr=False),
